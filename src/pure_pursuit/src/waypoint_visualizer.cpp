...
WaypointVisualizer::WaypointVisualizer() : Node("waypoint_visualizer") {
    this->declare_parameter("waypoints_path", "/home/f1tenth/f1tenth_ws/src/pure_pursuit/wp-2024-05-12-08-15-38.csv");
